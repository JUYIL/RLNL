...
class NodePolicy:
    ...
    # def __init__(self,sub, n_actions, n_features,num_epoch, batch_size, learning_rate=0.05):
            ...
            for req in training_set:
                ...
                if req.graph['type'] == 0:
                    ...
                    for vn_id in range(req.number_of_nodes()):
                        ...
                        sn_id = nodep.choose_max_action(observation,nodeenv.sub,req.nodes[vn_id]['cpu'],req.number_of_nodes())
                        if sn_id == -1:
                            break
                        else:
                            # 执行一次action，获取返回的四个数据
